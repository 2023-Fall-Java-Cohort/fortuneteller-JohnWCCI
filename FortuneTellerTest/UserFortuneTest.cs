    ...
    public class UserFortuneTest
    {
       private User testUser;
        ...
        public void Retirement_Years_By_Age(int age, int results, string comment)
        {
            ...
            Assert.That(results, Is.EqualTo(fortune.RetirementYears()));
        }
        ...
        {
            testUser.Sibling = siblings;
            UserFortune fortune = new UserFortune(testUser);
            Assert.That(results, Is.EqualTo(fortune.VacationHome()));
        }
        ...
        [TestCase(2, "$256,000.76", "Balance if February")]
        ...
        public void Bank_Balance_By_Month_Test(int month, string results, string comment)
        {
            ...
            UserFortune fortune = new UserFortune(testUser);
            Assert.That(results, Is.EqualTo(fortune.BankBalance()));
        }
    }
}
